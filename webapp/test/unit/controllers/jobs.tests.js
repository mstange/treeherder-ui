...
describe('JobsCtrl', function(){
    ...
    beforeEach(inject(function ($injector, $rootScope, $controller
        ...
        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=28').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=27').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=26').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=25').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=24').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=23').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=22').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=21').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=20').respond(
            getJSONFixture('resultset_list.json')
        );

        $httpBackend.whenGET(projectPrefix + 'jobs/?count=5000&full=true&result_set_id=19').respond(
            getJSONFixture('resultset_list.json')
        );
