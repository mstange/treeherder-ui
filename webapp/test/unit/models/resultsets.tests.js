...
describe('ThResultSetStore', function(){
    ...
    beforeEach(inject(function ($injector, $rootScope, $controller,
        ...
        $httpBackend.whenGET(foregroundPrefix + '/jobs/?count=5000&full=true&result_set_id=1').respond(
            getResultSet(1)
        );

        $httpBackend.whenGET(foregroundPrefix + '/jobs/?count=5000&full=true&result_set_id=10').respond(
            getResultSet(10)
        );
